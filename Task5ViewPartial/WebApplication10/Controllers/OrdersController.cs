...
namespace WebApplication10.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var orders = db.Orders.Include(o => o.TaskEmployee);
        ...
        {
            ViewBag.CustomerID = new SelectList(db.TaskEmployees, "Id", "First_Name");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "OrderID,CustomerID,OrderDate")] Order order)
        {
            ...
            ViewBag.CustomerID = new SelectList(db.TaskEmployees, "Id", "First_Name", order.CustomerID);
            return View(order);
        }
